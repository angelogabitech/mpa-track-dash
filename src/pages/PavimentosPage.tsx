    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline" size="sm" onClick={clearAllData} className="gap-1.5 text-destructive hover:text-destructive">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    onClick={(e) => { e.stopPropagation(); removePavimento(pav.id); }}
