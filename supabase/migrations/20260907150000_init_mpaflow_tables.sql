-- ============================================================================
-- MPaFlow â€” Migration portÃ¡til: tabelas do domÃ­nio (Pavimentos, CaminhÃµes, CPs)
-- ============================================================================
-- Execute APÃ“S o script 001_init_auth.sql.
-- Cria toda a estrutura de dados do MPaFlow no seu prÃ³prio banco PostgreSQL.
--
-- Hierarquia:
--   profiles (usuÃ¡rio)
--     â””â”€â”€ pavimentos
--           â””â”€â”€ trucks (caminhÃµes / cargas)
--                 â””â”€â”€ test_specimens (corpos de prova)
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- TABELA: trucks (caminhÃµes / cargas de concreto)
-- ----------------------------------------------------------------------------
...
-- PrÃ³ximo passo (opcional): migrar dados do localStorage do app para o banco.
-- ============================================================================
